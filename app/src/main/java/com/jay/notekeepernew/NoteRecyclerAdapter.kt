...
class NoteRecyclerAdapter(private val context: Context, private val notes : List<NoteInfo>) :
    ...
    val NOTE_POSITION = "EXTRA_NOTE_POSITION"
    private val onNoteSelectedListener:OnNoteSelectedListener? = null
    ...
    fun setOnSelectedItemListener(listener: OnNoteSelectedListener){
    }
