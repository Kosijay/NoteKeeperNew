...
object DataManager {
    ...
    private fun initializeCourses (){
        ...
        course = CourseInfo("KotlinToLearn", "KosiJay's personal input" )
        courses[course.courseId] = course

        course = CourseInfo("KosiJay", "Jumper")
        courses[course.courseId] = course
    ...
    private fun initializeNotes(){
        ...
        course = courses["KosiJay"]!!
        note = NoteInfo(course, "KosiJay working",
            "This has been fun so let's Move on to the next chapter. Shall we?")
        notes.add(note)

        course = courses["KosiJay"]!!
        note = NoteInfo(course, "VERY TIRED BOY",
            "Just me adding more items to make it easier to see whats going on.\n This will be duplicated a few times. Here's number 1")
        notes.add(note)
        course = courses["KosiJay"]!!
        note = NoteInfo(course, "VERY TIRED BOY",
            "Just me adding more items to make it easier to see whats going on.\n This will be duplicated a few times. Here's number 2")
        notes.add(note)
        course = courses["KosiJay"]!!
        note = NoteInfo(course, "VERY TIRED BOY",
            "Just me adding more items to make it easier to see whats going on.\n This will be duplicated a few times. Here's number 3")
        notes.add(note)
        course = courses["KosiJay"]!!
        note = NoteInfo(course, "VERY TIRED BOY",
            "Just me adding more items to make it easier to see whats going on.\n This will be duplicated a few times. Here's number 4")
        notes.add(note)
        course = courses["KosiJay"]!!
        note = NoteInfo(course, "VERY TIRED BOY",
            "Just me adding more items to make it easier to see whats going on.\n This will be duplicated a few times. Here's number 5")
        notes.add(note)
        course = courses["KosiJay"]!!
        note = NoteInfo(course, "VERY TIRED BOY",
            "Just me adding more items to make it easier to see whats going on.\n This will be duplicated a few times. Here's number 6")
        notes.add(note)
    }
}
